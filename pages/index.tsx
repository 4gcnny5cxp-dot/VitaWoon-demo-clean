      ...
      <div className="container">
        <div className="card" style={{ padding: 22 }}>
          ...
          <p className="muted" style={{ maxWidth: 900, lineHeight: 1.7 }}>
            VitaWoon helpt ouderen en hun naasten om rustig vooruit te kijken. U begint bij wat telt: comfortabel wonen,
            een fijne omgeving en welzijn. En als er later iets verandert, helpen we om hulp, ondersteuning of zorg te
            organiseren — zonder dat het nu al “over zorg” hoeft te gaan.
          </p>
        ...
        <div style={{ marginTop: 18, display: "grid", gap: 14, gridTemplateColumns: "1fr 1fr" }}>
          <div className="card">
            ...
            <p className="muted" style={{ marginTop: 8, lineHeight: 1.6 }}>
              Vul in wat u nu heeft en wat u later wilt kunnen organiseren. U ziet direct passend aanbod (demo),
              én u kunt zich per complex inschrijven (wachtlijst).
            </p>
          ...
          <div className="card">
            ...
            <p className="muted" style={{ marginTop: 8, lineHeight: 1.6 }}>
              ...
              Inclusief proces- en kwaliteitsafspraken (VitaDomus/alternatief).
            </p>
